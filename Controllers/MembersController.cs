...
namespace E_knjiznica.Controllers
{
    public class MembersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MemberID,FirstMidName,LastName,Email,PhoneNumber,MembershipDate,SubsidiaryID,Username,Credentials")] Member member)
        {
