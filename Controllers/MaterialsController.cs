...
namespace E_knjiznica.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaterialID,Title,Genre,PublicationYear,AuthorID")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaterialID,Title,Genre,PublicationYear,AuthorID")] Material material)
        {
